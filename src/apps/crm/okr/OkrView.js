...
import OkrView from "flexbiz-core/components/okr/OkrView";
...
class OkrViewPage extends PureComponent{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return (
      <Container requireLogin {...this.props}  showDrawerIfIsDesktop={false}>
        ...
        <OkrView {...this.props} currentTab = {this.currentTab} _id={this.props.match.params._id}  style={{height:height,paddingLeft:10,paddingRight:10}}/>
      </Container>
    )
  }
}
OkrViewPage.contextType = AuthContext;
OkrViewPage.propTypes={
  match: PropTypes.any,
  history: PropTypes.any,
  location: PropTypes.any,
  mediaQueryMatches: PropTypes.bool,
}
export default  withRouter(withMediaQuery('(max-width:480px)')(OkrViewPage));