...
import StrategicPlanView from "flexbiz-core/components/strategic/StrategicPlanView";
...
class StrategicPlanPage extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return (
      <Container requireLogin {...this.props}  showDrawerIfIsDesktop={false}>
        ...
        <StrategicPlanView {...this.props} currentTab={this.currentTab} _id={this.props.match.params._id} style={{height:height,paddingLeft:10,paddingRight:10}}/>
      </Container>
    )
  }
}
StrategicPlanPage.contextType = AuthContext;
...
export default  withRouter(withMediaQuery('(max-width:480px)')(StrategicPlanPage));