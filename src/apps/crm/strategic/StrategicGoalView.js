...
import StrategicGoalView from "flexbiz-core/components/strategic/StrategicGoalView";
...
class StrategicGoalPage extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return (
      <Container requireLogin {...this.props}  showDrawerIfIsDesktop={false}>
        ...
        <StrategicGoalView {...this.props} currentTab={this.currentTab} _id={this.props.match.params._id} style={{height:height,paddingLeft:10,paddingRight:10}}/>
      </Container>
    )
  }
}
StrategicGoalPage.contextType = AuthContext;
StrategicGoalPage.propTypes={
  match: PropTypes.any,
  history: PropTypes.any,
  location: PropTypes.any,
  mediaQueryMatches: PropTypes.bool,
}
export default  withRouter(withMediaQuery('(max-width:480px)')(StrategicGoalPage));